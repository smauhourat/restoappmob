...
export async function getProducts() {
  const URL_API = `${BASE_URL}/api/productos`;
...
export async function getOrders() {
  const URL_API = `${BASE_URL}/api/pedidos`;
  const rawData = await fetch(URL_API);
  const json = await rawData.json();
  return json;
}
...
export async function getOrderById(orderId) {
  const URL_API = `${BASE_URL}/api/pedidos/${orderId}`;
  const rawData = await fetch(URL_API);
  const json = await rawData.json();
  return json;
}
...
export async function getProviders() {
  const URL_API = `${BASE_URL}/api/proveedores`;
  const rawData = await fetch(URL_API);
  const json = await rawData.json();
  return json;
}
...
export async function getProductsForProvider(providerId) {
  const URL_API = `${BASE_URL}/api/proveedores/${providerId}/productos`;
  const rawData = await fetch(URL_API);
  const json = await rawData.json();
  return json;
}
...
async function getNroPedido() {
  const URL_API = `${BASE_URL}/api/pedidos/nropedido`;
